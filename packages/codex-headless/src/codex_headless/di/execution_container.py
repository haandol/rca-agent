...
from codex_headless.ports.interfaces.evidence_store import EvidenceStorePort
from codex_headless.ports.interfaces.execution_runner import ExecutionRunnerPort
from codex_headless.ports.interfaces.execution_store import ExecutionStorePort
...
class AppExecutionContainer(ExecutionContainer):
    ...
    def evidence_store(self) -> EvidenceStorePort:
        if self._evidence_store is None:
            from codex_headless.adapters.secondary.evidence.s3_evidence_store import S3EvidenceStore
    ...
    def playbook_store(self) -> PlaybookStorePort:
        if self._playbook_store is None:
            ...
            from codex_headless.adapters.secondary.playbook.s3_vectors_playbook_store import (
    ...
    def execution_runner(self) -> ExecutionRunnerPort:
        if self._execution_runner is None:
            from codex_headless.adapters.secondary.codex.codex_execution_runner import CodexExecutionRunner
