...
from codex_headless.config.settings import DYNAMODB_TABLE_NAME, ENGINE, SESSION_TTL_DAYS
...
_ANALYSIS_SESSION_SKS = ("strands#SESSION", "SESSION", "codex-headless#SESSION", "cc-headless#SESSION")
