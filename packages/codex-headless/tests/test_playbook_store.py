...
from codex_headless.config.settings import PLAYBOOK_UPDATE_THRESHOLD
from codex_headless.ports.interfaces.playbook_store import PlaybookMatch

_MODULE = "codex_headless.adapters.secondary.playbook.s3_vectors_playbook_store"
...
def _staged_revision_item(playbook_id: str = "pb-1") -> dict:
    ...
    item["SK"] = {"S": "codex-headless#PLAYBOOK_REVISION_STAGE#exec-9"}
