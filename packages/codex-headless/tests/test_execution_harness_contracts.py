...
from codex_headless.ports.interfaces.execution_store import ExecutionTarget
from codex_headless.services.execution_prompt import build_execution_prompt
...
def test_packaged_servers_use_the_package_root_placeholder():
    ...
    assert execution["args"][1] == "{{PACKAGE_ROOT}}/src/codex_headless/execution_mcp_server.py:mcp"
    assert retrospective["args"][1] == "{{PACKAGE_ROOT}}/src/codex_headless/retrospective_mcp_server.py:mcp"
...
def test_image_installs_the_executable_the_gate_allows():
    from codex_headless.services.command_gate import _ALLOWED_EXECUTABLE
