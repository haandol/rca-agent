...
APPROVAL = {
    ...
    "report_s3_key": "reports/codex-headless/rca-1/report.md",
...
def test_a_user_approval_becomes_an_execution_request():
    ...
    assert request.engine == "codex-headless"
...
@pytest.mark.parametrize("engine", ["strands", "codex-headless", "cc-headless"])
