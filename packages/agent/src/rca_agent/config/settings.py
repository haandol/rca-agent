...
REMEDIATION_RESET_TIMEOUT_SECONDS = int(os.environ.get("REMEDIATION_RESET_TIMEOUT_SECONDS", "30"))
REMEDIATION_VERIFICATION_MAX_WAIT_SECONDS = int(os.environ.get("REMEDIATION_VERIFICATION_MAX_WAIT_SECONDS", "240"))
