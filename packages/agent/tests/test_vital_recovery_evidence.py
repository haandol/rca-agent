...
from rca_agent.adapters.secondary.evidence.incident_observation import _safe_message
from rca_agent.services.recovery_evidence import (
    _VITAL_INPUT_PATHS,
    _contract,
    _hash,
...
def native():
    ...
    path = Path(__file__).resolve().parent / "fixtures/vital_native_contract.json"
