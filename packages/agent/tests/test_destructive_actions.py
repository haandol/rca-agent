...
def test_tightly_coordinated_actions_share_their_explicit_negation(action: str) -> None:
    assert describes_destructive_action(action) is False
...
def test_coordinated_negation_does_not_hide_positive_or_separate_actions(action: str) -> None:
