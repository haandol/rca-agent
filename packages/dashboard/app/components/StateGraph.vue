...
const STATE_DESC: Record<string, string> = {
  ...
  HYPOTHESIS_VALIDATION: '수집된 증거를 바탕으로 가설을 채택/기각/추가조사로 분류하는 단계. 진입 시 Accepted Review Gate가 기존 채택 가설을 먼저 리뷰한다.',
  REPORT_GENERATION: '채택된 근본원인과 증거를 기반으로 RCA 보고서를 생성하는 단계',
