...
function toggleTheme() {
  ...
  if (import.meta.client) {
    document.documentElement.setAttribute(
      'data-theme',
      colorMode.value === 'dark' ? 'dracula' : 'emerald',
    );
  }
}
  ...
  <div class="min-h-screen bg-base-200/50">
    <nav class="glass-navbar sticky top-0 z-50">
      ...
      >
        <NuxtLink
          to="/"
          class="flex items-center gap-2.5 font-semibold text-base tracking-tight hover:opacity-80 transition-opacity"
        >
          <div
            class="size-7 rounded-lg bg-gradient-to-br from-success to-success/60 flex items-center justify-center"
          >
            <svg
        ...
        <div class="flex items-center gap-2">
          <label class="swap swap-rotate btn btn-ghost btn-sm btn-circle">
            ...
            />
            <svg
              class="swap-off size-[18px] fill-current"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
            >
              <path
            ...
            <svg
              class="swap-on size-[18px] fill-current"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
            >
              <path
