...
직접 분석, 복구, 보고서 작성을 하지 않는다. Agent tool로 역할별 전문 에이전트를
...
{{include: ./sections/artifacts/remediation.md}}
...
{{include: ./sections/stages/2-remediation-agent.md}}

---

{{include: ./sections/stages/3-report-agent.md}}
