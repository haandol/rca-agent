...
class TestActiveIncident:
    ...
    def test_realarm_is_suppressed_while_analysis_is_active(self, session_store, session_sk):
...
def test_terminal_session_is_never_reclaimed(session_store, terminal_state):
    ...
    if terminal_state == "COMPLETED":
        ...
        store.mark_completed(
            "rca-1",
            "root cause",
            "reports/headless-codex/rca-1/report.md",
...
def test_completion_atomically_persists_authoritative_report_key(session_store):
    ...
    store.mark_completed(
        ...
        "reports/headless-codex/rca-1/attempt-1/report.md",
        playbook={
