...
from headless_codex.config.settings import PLAYBOOK_UPDATE_THRESHOLD
from headless_codex.ports.interfaces.playbook_store import PlaybookMatch

_MODULE = "headless_codex.adapters.secondary.playbook.s3_vectors_playbook_store"
...
def _staged_revision_item(playbook_id: str = "pb-1") -> dict:
    ...
    item["SK"] = {"S": "headless-codex#PLAYBOOK_REVISION_STAGE#exec-9"}
