...
- **`packages/healthcare-sensor-app`** – 헬스케어 센서 데이터 수집/조회 서비스. Background traffic generator가 CloudWatch baseline 메트릭을 축적하며, fault injection API로 장애 시나리오를 재현합니다. PostgreSQL(RDS) 연동.
